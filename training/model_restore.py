...
def recursive_find_python_class(folder, trainer_name, current_module):
    ...
    for importer, modname, ispkg in pkgutil.iter_modules(folder):
        ...
        if modname == "nnUNetTrainerV2_MedNeXt":
            current_module="nnunet_mednext.training.network_training.MedNeXt"
        # current_module="nnunet_mednext.experiment_planning"
        if modname=="cropping":
            current_module="nnunet_mednext.preprocessing"
        if modname=="preprocessing":
            current_module="nnunet_mednext.preprocessing"
        if modname=="sanity_checks":
            current_module="nnunet_mednext.preprocessing"
        if modname=="experiment_planner_baseline_3DUNet_v21_11GB":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v21_11GB"
        if modname=="experiment_planner_baseline_3DUNet_v21_16GB":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v21_16GB"
        if modname=="experiment_planner_baseline_3DUNet_v21_32GB":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v21_32GB"
        if modname=="experiment_planner_baseline_3DUNet_v21_3convperstage":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v21_3convperstage"
        if modname=="experiment_planner_baseline_3DUNet_v22":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v22"
        if modname=="experiment_planner_baseline_3DUNet_v23":
            modname="alternative_experiment_planning.experiment_planner_baseline_3DUNet_v23"
        if modname=="experiment_planner_pretrained":
            modname="alternative_experiment_planning.experiment_planner_pretrained"
        if modname=="experiment_planner_residual_3DUNet_v21":
            modname="alternative_experiment_planning.experiment_planner_residual_3DUNet_v21"
        if modname=="experiment_planner_2DUNet_v21_RGB_scaleto_0_1":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.normalization"
        if modname=="experiment_planner_3DUNet_CT2":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.normalization"
        if modname=="experiment_planner_3DUNet_nonCT":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.normalization"
        if modname=="experiment_planner_3DUNet_isotropic_in_mm":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.patch_size"
        if modname=="experiment_planner_3DUNet_isotropic_in_voxels":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.patch_size"
        # /home/data/lrd/zgp/MedNeXt/nnunet_mednext/experiment_planning/alternative_experiment_planning/pooling_and_convs
        if modname=="experiment_planner_baseline_3DUNet_allConv3x3":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.pooling_and_convs"
        if modname=="experiment_planner_baseline_3DUNet_poolBasedOnSpacing":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.pooling_and_convs"
        if modname=="experiment_planner_baseline_3DUNet_targetSpacingForAnisoAxis":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.target_spacing"
        if modname=="experiment_planner_baseline_3DUNet_v21_customTargetSpacing_2x2x2":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.target_spacing"
        if modname=="experiment_planner_baseline_3DUNet_v21_noResampling":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.target_spacing"
        if modname=="experiment_planner_v21_isotropic1mm":
            current_module="nnunet_mednext.experiment_planning.alternative_experiment_planning.target_spacing"
        
        if not ispkg:
            a=current_module + "." + modname
            if a=='nnunet_mednext.experiment_planning.network_trainer':
                current_module="nnunet_mednext"
